          ...
          <div key={char.instanceId} className={`border-b border-gray-200 last:border-0 bg-white`}>
            ...
            >
                <div className="flex items-center justify-between">
                    ...
                    {/* Green Circular Arrow Button */}
                    <div className={`
                        w-7 h-7 rounded-full flex items-center justify-center shadow-sm ml-2 transition-all duration-300 border border-green-600
                        ${isExpanded ? 'bg-[#66D814] rotate-180' : 'bg-[#66D814] hover:bg-[#5CC012]'}
                    `}>
