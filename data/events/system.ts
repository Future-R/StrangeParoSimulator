...
export const SYSTEM_EVENTS: GameEvent[] = [
  ...
  },
  {
    ...
    选项组: [
      ...
      { 显示文本: '喝茶谈心', 操作指令: '属性变更 精力 5; 随机角色.属性变更 精力 5; 属性变更 心情 5; 关系变更(友情, 随机角色, 训练员, 5)' }
    ]
  },
  {
  ...
  // ===========================
  {
    ...
    选项组: [
      { 显示文本: '享受崇拜的目光', 操作指令: '属性变更 心情 10; 属性变更 魅力 2; 随机角色.属性变更 智慧 5; 关系变更(友情, 随机角色, 训练员, 5)' },
      { 显示文本: '趁热打铁进行指导', 操作指令: '属性变更 学识 1; 属性变更 体力 -20; 随机角色.属性变更 速度 10' }
    ]
  },
  {
    ...
    选项组: [
      { 显示文本: '压抑本能，保持专业', 操作指令: '随机角色.属性变更 速度 15; 属性变更 精力 -8' },
      { 显示文本: '加入陪跑！', 操作指令: '属性变更 速度 20; 属性变更 体力 -20; 属性变更 心情 5; 关系变更(友情, 随机角色, 训练员, 5)' }
    ]
  },
  {
    id: 'uma_trainer_tail',
  ...
  },
  {
    ...
    选项组: [
      { 显示文本: '我的梦想是培养她们', 操作指令: '属性变更 毅力 20; 属性变更 学识 5; 属性变更 心情 5' },
      { 显示文本: '稍微有点心动……', 操作指令: '属性变更 速度 30; 获得标签 优柔寡断' }
    ]
  },
  {
    id: 'trainer_sm_chair',
  ...
  // ===========================
  {
    ...
    标题: '团建时刻',
    正文: '队伍的规模逐渐壮大，{当前角色.名称}看着热闹的训练场，决定组织一次团建活动来巩固大家的羁绊。',
    选项组: [
      {
        显示文本: '今晚去吃烤肉吧！',
  ...
  },
  {
    ...
    触发条件: 'false',
    标题: '入坑宣言',
    正文: '“诶诶诶？！这是什么神展开？！我也能加入那个充满了尊贵互动的队伍吗？！”\n{目标.名称}激动地握住你的手，甚至开始语无伦次。\n“难道说……我也能近距离摄取那神圣的‘尊’分了吗？这是何等的福利！这是何等的供给！”\n“训练员氏！请务必让我入队！我会作为一个合格的背景板努力的！”',
