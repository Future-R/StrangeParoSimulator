...
export const SYSTEM_EVENTS: GameEvent[] = [
  ...
  // --- 热血训练员工作事件 ---
  {
    ...
    可触发次数: -1,
    标签组: ['工作', '热血'],
    触发条件: '当前角色.标签组 存在 "训练员" && 当前角色.标签组 存在 "热血" && 当前角色.属性.精力 > 15',
    预操作指令: '设置变量 角色 随机角色 = 获取随机队友()',
    标题: '热血指导',
    正文: '“{随机文字("噢噢噢噢噢哦哦！","燃起来吧{随机角色.名称}！","训练多流汗，比赛少流血！")}” 你拉着{随机角色.名称}特训！',
    选项组: [
      { 显示文本: '长跑特训', 操作指令: '属性变更 精力 -15; 随机角色.属性变更 耐力 15; 随机角色.属性变更 体力 -10; 关系变更(友情, 随机角色, 训练员, 5)' },
      { 显示文本: '拖轮胎特训', 操作指令: '属性变更 精力 -15; 随机角色.属性变更 力量 15; 随机角色.属性变更 体力 -10; 关系变更(友情, 随机角色, 训练员, 5)' }
    ]
  },
  ...
  // --- 新增：老成训练员工作事件 ---
  {
    ...
    选项组: [
      { 显示文本: '磨练心性 (毅力UP)', 操作指令: '属性变更 精力 -15; 随机角色.属性变更 毅力 15; 关系变更(友情, 随机角色, 训练员, 5)' },
      { 显示文本: '分析数据 (智慧UP)', 操作指令: '属性变更 精力 -15; 随机角色.属性变更 智慧 15; 关系变更(友情, 随机角色, 训练员, 5)' },
      { 显示文本: '喝茶谈心 (休息)', 操作指令: '属性变更 体力 10; 属性变更 心情 5; 关系变更(友情, 随机角色, 训练员, 5)' }
    ]
  },
  ...
  // --- 新增：魅力十足通用事件 (无选项) ---
  {
    ...
    标题: '广告邀约',
    正文: '凭借着出众的外貌和气质，{当前角色.名称}在街上被星探发掘，临时拍摄了一支饮料广告。虽然只是短暂的镜头，但足以让人印象深刻。',
  ...
  // --- 强制休息事件 ---
  {
    ...
    权重: 100, // High weight to trigger if low
    可触发次数: -1,
    标签组: ['休息'],
  ...
  },
  {
    ...
    触发条件: '当前角色.属性.财富 > 5',
    标题: '卡拉OK',
    正文: '被朋友邀请去卡拉OK唱歌。{当前角色.标签组 存在 "歌手" ? "当拿起麦克风的瞬间，整个包厢都被你的歌声征服了！" : ""}',
    选项组: [
  ...
  },
  {
    ...
    选项组: [
      { 显示文本: '去更衣室梳理一下', 操作指令: '属性变更 魅力 2; 属性变更 心情 5' },
