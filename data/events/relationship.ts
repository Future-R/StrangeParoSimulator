...
export const RELATIONSHIP_EVENTS: GameEvent[] = [
  ...
  },
  {
    ...
    可触发次数: -1,
    标签组: ['暧昧'],
    触发条件: '当前角色.标签组 存在 "在役" && (当前角色.标签组 存在 "木头" || 当前角色.属性.智慧 < 120)',
    标题: '试吃一口',
  ...
  },
  {
    ...
    触发条件: 'false',
    标题: '特殊的常识课',
    正文: '你抓住了她拿着勺子的手腕，盯着她的唇，露出了危险的笑容。“既然是喂食，那就应该用这里……”',
    操作指令: '属性变更 爱欲 30; 关系变更 爱情 5; 属性变更 精力 -10; 移除标签 木头 若 随机(1~100) >= 50'
  },
  {
  ...
  },
  {
    ...
    选项组: [
      ...
      { 显示文本: '抽出手指', 操作指令: '属性变更 心情 -10; 属性变更 爱欲 20' }
    ]
  },
  {
    id: 'h_locked_room',
