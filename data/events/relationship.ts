...
export const RELATIONSHIP_EVENTS: GameEvent[] = [
  ...
  },
  {
    ...
    选项组: [
      { 显示文本: '张嘴吃下', 操作指令: '属性变更 体力 5; 属性变更 爱欲 5; 关系变更 爱情 10; 获得标签 肥胖 若 随机(1100) >= 50' },
      { 显示文本: '教授常识', 操作指令: '属性变更 学识 1; 移除标签 木头 若 随机(1100) >= 90' },
      {
        显示文本: '身体教育',
  ...
  },
  {
    ...
    操作指令: '属性变更 爱欲 30; 关系变更 爱情 5; 属性变更 精力 -10; 移除标签 木头 若 随机(1100) >= 60'
  },
  {
