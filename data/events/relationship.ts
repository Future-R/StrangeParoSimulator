...
export const RELATIONSHIP_EVENTS: GameEvent[] = [
  ...
  },
  {
    ...
    选项组: [
      ...
      { 显示文本: '让她找别人', 操作指令: '属性变更 心情 -5; 关系变更 爱情 -3; 属性变更 毅力 2' }
    ],
    分支组: [
        {
            判别式: '已选序号 == 2 && 变量存在 第三者',
  ...
  },
  {
    ...
    选项组: [
      { 显示文本: '张嘴吃下', 操作指令: '属性变更 体力 5; 属性变更 爱欲 5; 关系变更 爱情 10; 获得标签 肥胖 若 随机(1~100) >= 50' },
      { 显示文本: '教授常识', 操作指令: '属性变更 学识 1; 移除标签 木头 若 随机(1~100) >= 90' },
      {
        显示文本: '身体教育',
  ...
  },
  {
    ...
    选项组: [
      ...
      { 显示文本: '耳朵变红了', 操作指令: '属性变更 魅力 1; 关系变更 爱情 5' }
    ]
  },
  ...
  },
  {
    ...
    选项组: [
      { 显示文本: '转身吻住她', 操作指令: '属性变更 爱欲 -30; 属性变更 精力 -30; 关系变更 爱情 20; 属性变更 心情 20; 交合(当前角色, 训练员)' },
  ...
  // ===========================
  {
    ...
    选项组: [
      ...
      { 显示文本: '顺势而为', 操作指令: '属性变更 爱欲 10; 关系变更 爱情 5; 获得标签 沉重; 跳转 h_dom_bite' }
    ]
  },
  {
    id: 'h_dom_bite',
    ...
    选项组: [
      { 显示文本: '彻底臣服', 操作指令: '属性变更 爱欲 -30; 属性变更 心情 20; 关系变更 爱情 20; 获得标签 变态; 交合(当前角色, 训练员)' },
  ...
  },
  {
    ...
    选项组: [
      { 显示文本: '答应她的任何要求', 操作指令: '属性变更 爱欲 20; 属性变更 精力 -30; 关系变更 爱情 10; 获得标签 变态; 交合(当前角色, 训练员)' },
      { 显示文本: '试图抢夺', 操作指令: '属性变更 体力 -20; 属性变更 心情 -10; 属性变更 爱欲 10' }
    ]
  },
  {
    ...
    选项组: [
      ...
      { 显示文本: '彻底放弃抵抗', 操作指令: '属性变更 爱欲 -40; 属性变更 精力 -40; 关系变更 爱情 10; 属性变更 心情 10; 交合(当前角色, 训练员)' }
    ]
  },
  {
    id: 'h_tail_care',
  ...
  },
  {
    ...
    选项组: [
      { 显示文本: '滑向禁区', 操作指令: '属性变更 爱欲 20; 关系变更 爱情 10; 跳转 h_massage_deep' },
      { 显示文本: '有多大力使多大力', 操作指令: '属性变更 体力 20; 属性变更 爱欲 5; 关系变更 友情 5' }
    ]
  },
  {
    id: 'h_massage_deep',
    ...
    选项组: [
      { 显示文本: '就在这里解决', 操作指令: '跳转 h_massage_deep_climax' },
      { 显示文本: '抽出手指', 操作指令: '跳转 h_massage_deep_deny' }
    ]
  },
  {
    ...
    // CHANGED: Removed 获得标签 沉重
    操作指令: '属性变更 爱欲 -60; 属性变更 精力 -40; 属性变更 心情 20; 关系变更 爱情 30; 交合(当前角色, 训练员)'
  },
  {
  ...
  },
  {
    ...
    选项组: [
      ...
      { 显示文本: '在黑暗中接吻', 操作指令: '属性变更 爱欲 30; 关系变更 爱情 10; 属性变更 心情 10' }
    ]
  },
  {
    id: 'h_reward_time',
    ...
    选项组: [
      { 显示文本: '接受奖励', 操作指令: '属性变更 爱欲 -50; 属性变更 精力 -30; 属性变更 心情 20; 关系变更 爱情 10; 交合(当前角色, 训练员)' },
      { 显示文本: '摸摸头就好', 操作指令: '属性变更 爱欲 10; 属性变更 心情 -10; 关系变更 爱情 -5' }
    ]
  },
  {
    id: 'h_solo_witness',
    ...
    选项组: [
      ...
      { 显示文本: '推门而入', 操作指令: '属性变更 爱欲 -30; 关系变更 爱情 20; 属性变更 心情 10; 获得标签 变态; 交合(当前角色, 训练员)' }
    ]
  },
  {
  ...
  },
  {
    ...
    选项组: [
      ...
      { 显示文本: '更加严格地指导', 操作指令: '随机角色.属性变更 毅力 5; 随机角色.属性变更 爱欲 10' }
    ]
  },
  {
    id: 'uma_heat',
    ...
    选项组: [
      { 显示文本: '义正辞严地拒绝', 操作指令: '属性变更 毅力 5; 属性变更 爱欲 -10; 属性变更 心情 -10' },
      { 显示文本: '顺势而为', 操作指令: '属性变更 爱欲 20; 属性变更 精力 -20; 获得标签 沉重; 关系变更 爱情 10; 交合(当前角色, 训练员)' }
    ]
  }
];
