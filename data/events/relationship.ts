...
export const RELATIONSHIP_EVENTS: GameEvent[] = [
  ...
  },
  {
    ...
    选项组: [
      ...
      { 显示文本: '彻底放弃抵抗', 操作指令: '属性变更 爱欲 -40; 属性变更 精力 -40; 关系变更 爱情 10; 属性变更 心情 10' }
    ]
  },
  {
    id: 'h_tail_care',
  ...
  },
  {
    ...
    选项组: [
      { 显示文本: '接受奖励', 操作指令: '属性变更 爱欲 -50; 属性变更 精力 -30; 属性变更 心情 20; 关系变更 爱情 10' },
    ...
    分支组: [
      {
        ...
        操作指令: '获得标签 社死; 属性变更 心情 -80; 关系变更(友情, 随机角色, 训练员, -20)',
      },
      {
