...
export const NARRATIVE_EVENTS: GameEvent[] = [
  ...
  },
  {
    ...
    标签组: ['梗'],
    触发条件: '当前角色.模板ID != "黄金船"',
    正文: '经过一个戴着墨镜的马娘身边时，她忽然开口道：“Domo，{当前角色.名称}=san，忍者杀手Desu。”{当前角色.标签组 存在 "吐槽役" ? "\n{当前角色.名称}：哦哦，实际强大！" : ""}',
    分支组: [
      {
        判别式: '当前角色.标签组 存在 "吐槽役"',
        操作指令: '属性变更 心情 3',
  ...
  },
  {
    ...
    标签组: ['梗'],
    触发条件: '当前角色.模板ID != "黄金船"',
    正文: '经过一个戴着墨镜的马娘身边时，她忽然开口道：“哦？居然不逃跑反而向我走来吗？”{当前角色.标签组 存在 "吐槽役" ? "\n{当前角色.名称}：要是不走近点，是不是就用不着吐槽了……" : ""}',
    分支组: [
      {
        判别式: '当前角色.标签组 存在 "吐槽役"',
        操作指令: '属性变更 心情 3',
  ...
  },
  {
    ...
    触发条件: '当前角色.标签组 存在 "训练员"',
    标题: '出行邀请',
    正文: '“{当前角色.名称}训练员，休息日了要一起出门走走吗。”骏川手纲突然出现在你的面前对你发出邀请。',
    选项组: [
      { 显示文本: '去吃饭', 操作指令: '属性变更 体力 20; 属性变更 心情 10; 双向关系变更(友情, 当前角色/骏川手纲, 5)' },
      { 显示文本: '去购物', 操作指令: '属性变更 精力 15; 属性变更 心情 15; 属性变更 财富 -1; 双向关系变更(友情, 当前角色/骏川手纲, 5)' },
