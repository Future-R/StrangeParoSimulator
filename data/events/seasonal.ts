...
export const SEASONAL_EVENTS: GameEvent[] = [
  ...
  // ===========================
  {
    ...
    选项组: [
      { 
        显示文本: '去找{选项A.名称}', 
        操作指令: '双向关系变更(友情, 选项A/训练员, 随机(50~150))' 
      },
      { 
        显示文本: '去找{选项B.名称}', 
        操作指令: '双向关系变更(友情, 选项B/训练员, 随机(50~150))' 
      },
      { 
        显示文本: '去找{选项C.名称}', 
        操作指令: '双向关系变更(友情, 选项C/训练员, 随机(50~150))' 
      }
    ]
  }
];
