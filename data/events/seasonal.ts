...
export const SEASONAL_EVENTS: GameEvent[] = [
  {
    ...
    选项组: [
      ...
      { 显示文本: '祈祷比赛胜利', 操作指令: '属性变更 速度 20; 属性变更 力量 20; 属性变更 智慧 20; 属性变更 毅力 20; 属性变更 耐力 20' },
      { 显示文本: '祈祷良缘', 操作指令: '属性变更 爱欲 5; 关系变更 爱情 10; 关系变更 友情 10' }
    ]
  },
  {
    id: 'valentines_day',
  ...
  // ===========================
  {
    ...
    预操作指令: '设置变量 角色 选项A = 获取随机全员角色(); 设置变量 角色 选项B = 获取随机全员角色(); 设置变量 角色 选项C = 获取随机全员角色()',
    标题: '夏日合宿',
    正文: '夏日合宿期间，不仅是队伍里的成员，学园里的教职工和马娘们也都在一起训练。\n难得到了休息时间，你决定去看看谁呢？',
    选项组: [
      { 
        显示文本: '去找{选项A.名称}', 
        操作指令: '双向关系变更(友情, 选项A/训练员, 随机(5~15))' 
      },
      { 
        显示文本: '去找{选项B.名称}', 
        操作指令: '双向关系变更(友情, 选项B/训练员, 随机(5~15))' 
      },
      { 
        显示文本: '去找{选项C.名称}', 
        操作指令: '双向关系变更(友情, 选项C/训练员, 随机(5~15))' 
      }
    ]
  }
];
