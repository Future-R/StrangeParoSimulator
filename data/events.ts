...
export const EVENTS: GameEvent[] = [
  ...
  },
  {
    ...
    选项组: [
      { 显示文本: '张嘴吃下', 操作指令: '属性变更 体力 5; 属性变更 爱欲 5; 关系变更 爱情 10; 获得标签 肥胖' },
  ...
  // ===========================
  {
    ...
    可触发次数: -1,
    标签组: [],
    触发条件: '当前角色.标签组 存在 "在役" && 当前角色.标签组 不存在 "冷静"',
  ...
  },
  {
    ...
    正文: '为了制定新的训练计划，你不得不加班到深夜。窗外的特雷森学园静悄悄的。虽然辛苦，但为了那孩子的笑容，一切都是值得的。',
  ...
  },
  {
    ...
    触发条件: '当前角色.模板ID == "摩耶重炮"',
    标题: 'I Copy!',
    正文: '{当前角色.名称}正在模仿飞行员的动作。“You copy? I copy! 起飞！目标是{训练员.称呼}的怀抱！”',
    选项组: [
